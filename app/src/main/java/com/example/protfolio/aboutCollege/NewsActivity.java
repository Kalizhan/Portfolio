    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_about_college:
                intent = new Intent(NewsActivity.this, MainScreen.class);
            ...
            case R.id.nav_student:
                intent = new Intent(NewsActivity.this, StudentActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_employee:
                intent = new Intent(NewsActivity.this, EmployeeActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_login:
            ...
            case R.id.nav_profile:
                intent = new Intent(NewsActivity.this, ProfileActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_signup:
                intent = new Intent(NewsActivity.this, SignUpActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_share:
                intent = new Intent(NewsActivity.this, ShareActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_rate:
                intent = new Intent(NewsActivity.this, RateUsActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_about_us:
                intent = new Intent(NewsActivity.this, AboutUsActivity.class);
                startActivity(intent);
                break;
        }
        return true;
