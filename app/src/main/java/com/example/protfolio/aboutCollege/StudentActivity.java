    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_about_college:
                intent = new Intent(StudentActivity.this, MainScreen.class);
                startActivity(intent);
                break;
            case R.id.nav_news:
                intent = new Intent(StudentActivity.this, NewsActivity.class);
                startActivity(intent);
                break;
            ...
            case R.id.nav_employee:
                intent = new Intent(StudentActivity.this, EmployeeActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_login:
            ...
            case R.id.nav_signup:
                intent = new Intent(StudentActivity.this, SignUpActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_share:
                intent = new Intent(StudentActivity.this, ShareActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_rate:
                intent = new Intent(StudentActivity.this, RateUsActivity.class);
                startActivity(intent);
                break;
